...
class JugadorPrincipal(pygame.sprite.Sprite):
	...
	def __init__(self):
		...
		image = sprite_imagen.get_imagen(50, 0, 50, 58)
		self.walking_frames_r.append(image)
		image = sprite_imagen.get_imagen(100, 0, 50, 58)
		self.walking_frames_r.append(image)
		image = sprite_imagen.get_imagen(150, 0, 50, 58)
		self.walking_frames_r.append(image)	
		image = sprite_imagen.get_imagen(200, 0, 50, 58)
		self.walking_frames_r.append(image)
		image = sprite_imagen.get_imagen(250, 0, 50, 58)
		self.walking_frames_r.append(image)
